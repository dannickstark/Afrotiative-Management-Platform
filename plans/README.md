...
| 011 | States & feedback (EmptyState, loading skeletons, responsive tables, a11y) | ui/a11y | P1 | M | none | PARTIAL — A/B/C/D done; E (a11y labels + status-badge contrast) DEFERRED |
