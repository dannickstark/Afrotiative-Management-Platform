...
const PURE_FILES = new Set<string>([
  ...
  "video-brief.test.ts", "video-contract.test.ts", "video-duration.test.ts", "video-import-merge.test.ts", "video-import-parse.test.ts",
  "video-rbac-nav.test.ts", "video-schema-db.test.ts", "video-settings.test.ts",
