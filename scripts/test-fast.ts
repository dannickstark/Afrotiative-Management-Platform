...
const PURE_FILES = new Set<string>([
  ...
  "mcp-registry.test.ts", "mcp-schema.test.ts", "mcp-scope.test.ts", "mcp-settings-ui.test.ts", "mcp-token.test.ts", "mock-llm.test.ts", "montage-export.test.ts", "montage-export-bar.test.ts", "montage-share-dialog.test.ts", "montage-share-panel.test.ts", "montage-token.test.ts", "nav-sections.test.ts", "oauth-actor.test.ts", "oauth-connections-ui.test.ts", "oauth-consent-form.test.ts", "oauth-scope-map.test.ts", "page-header.test.ts", "pipeline-actions.test.ts", "pipeline-config.test.ts",
  "project-header.test.ts", "published.test.ts", "queue-queries.test.ts", "rbac.test.ts", "rbac-monteur.test.ts", "regen-live.test.ts", "regen-plan.test.ts", "regen-progress.test.ts", "resend.test.ts", "rss-parse.test.ts",
  ...
  "session-guard.test.ts", "settings-nav-icons.test.ts", "settings-rbac.test.ts",
  "shell-nav.test.ts", "smoke.test.ts", "speakers-manager.test.ts", "stat-card.test.ts",
  ...
  "studio-tokens.test.ts", "studio-use-preview.test.ts", "studio-values.test.ts", "timing-safe.test.ts", "tournage-rules.test.ts", "tournage-view.test.ts", "use-persisted-filters.test.ts",
  "beat-inspector-interview.test.ts",
