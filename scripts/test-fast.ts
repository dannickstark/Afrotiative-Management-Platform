...
const PURE_FILES = new Set<string>([
  ...
  "video-beat-list.test.ts", "video-brief-panel.test.ts", "video-brief.test.ts", "video-contract.test.ts", "video-duration.test.ts", "video-import-merge.test.ts", "video-import-parse.test.ts",
