...
const PURE_FILES = new Set<string>([
  ...
  "video-beat-list.test.ts", "video-brief-panel.test.ts", "video-brief.test.ts", "video-categories-rbac.test.ts", "video-categories-schema.test.ts", "video-categories-validation.test.ts", "video-contract.test.ts",
