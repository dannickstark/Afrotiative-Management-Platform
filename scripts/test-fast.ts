...
const PURE_FILES = new Set<string>([
  ...
  "video-labels.test.ts", "video-project-list.test.ts", "video-rbac-nav.test.ts", "video-schema-db.test.ts", "video-settings.test.ts",
