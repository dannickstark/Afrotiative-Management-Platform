...
const PURE_FILES = new Set<string>([
  ...
  "mcp-registry.test.ts", "mcp-schema.test.ts", "mcp-scope.test.ts", "mcp-settings-ui.test.ts", "mcp-token.test.ts", "mock-llm.test.ts", "nav-sections.test.ts", "oauth-actor.test.ts", "oauth-consent-form.test.ts", "oauth-scope-map.test.ts", "page-header.test.ts", "pipeline-actions.test.ts", "pipeline-config.test.ts",
