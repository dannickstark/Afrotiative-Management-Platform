...
const PURE_FILES = new Set<string>([
  ...
  "embeddings.test.ts", "extract-chain.test.ts", "extract-images.test.ts", "live-panel.test.ts",
  ...
  "score.test.ts", "search.test.ts", "settings-rbac.test.ts", "shell-nav.test.ts", "smoke.test.ts",
  ...
  "studio-element.test.ts", "studio-elements-panel.test.ts", "studio-fonts.test.ts", "studio-images.test.ts",
