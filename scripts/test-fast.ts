...
const PURE_FILES = new Set<string>([
  ...
  "mcp-registry.test.ts", "mcp-schema.test.ts", "mcp-token.test.ts", "mock-llm.test.ts", "nav-sections.test.ts", "page-header.test.ts", "pipeline-actions.test.ts", "pipeline-config.test.ts",
